...
const tabs = ['Overview', 'Beneficiaries', 'Enrollment Officers', 'Health Facility', 'Enrollment Activity', 'Activity Log'] as const
    ...
    <div className="flex flex-1 flex-col gap-6 p-4 sm:p-6">
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button disabled={detailQuery.isFetching} onClick={() => void openAssignment()}>{detailQuery.isFetching ? 'Refreshing…' : 'Assign Enrollment Officer'}</Button>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {[
          ...
          { label: 'Active Enrollment Officers', value: String(stats.activeFieldWorkers) },
