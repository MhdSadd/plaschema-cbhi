...
import { formatRecordBand } from '@/features/capitation/utils'
...
export function FacilityDetailView({ facilityId }: FacilityDetailViewProps) {
  ...
  const beneficiaryQuery = useEnrollments(
    { cursor: beneficiaryCursors[beneficiaryPage], healthFacilityId: facilityId, limit: 25 },
    tab === 'Beneficiaries',
  )
