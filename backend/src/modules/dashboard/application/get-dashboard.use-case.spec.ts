...
describe('GetDashboardUseCase', () => {
  ...
  const overview = {
    ...
    householdOverview: {
      totalMembers: 28,
      averageMembersPerHousehold: 2.3,
    },
    householdTrend: {
      total: 2,
      average: 1,
      granularity: 'monthly' as const,
      points: [{ key: '2026-08', label: 'Aug', count: 2 }],
    },
    householdByWard: [],
    householdByLga: [],
    householdSizeBreakdown: [
      { label: '1 member', count: 4 },
      { label: '2–3 members', count: 6 },
      { label: '4–5 members', count: 2 },
      { label: '6+ members', count: 0 },
    ],
    enrollmentTrend: {
      total: 3,
      average: 1,
